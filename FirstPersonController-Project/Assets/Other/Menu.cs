...
public class Menu : MonoBehaviour
{
    ...
    {
        GUI.skin = mySkin;
        if(GUI.Button(new Rect(origin_x, origin_y, buttonWidth, buttonHeight), "Third Person Scene"))
        {
            //load scene 1
            Application.LoadLevel(1);    
        }   
        //add more for more scenes
        if(GUI.Button(new Rect(origin_x, origin_y + buttonHeight + 20, buttonWidth, buttonHeight), "First Person Scene"))
        {
            //load scene 2
